...
},{}],"textAnimation.js":[function(require,module,exports) {
"use strict";
...
//\\//\\//\\//\\ TEXT ANIMATION //\\//\\//\\//\\
var textAnimation = _animejs.default.timeline({
  easing: "easeOutExpo",
  duration: 750,
...
textAnimation.pause(); //\\//\\//\\//\\ END TEXT ANIMATION //\\//\\//\\//\\
},{"animejs":"node_modules/animejs/lib/anime.es.js"}],"imageAnimation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.imageAnimation = void 0;
...
//\\//\\//\\//\\ IMAGE ANIMATION //\\//\\//\\//\\
var imageAnimation = _animejs.default.timeline({
  easing: "easeOutExpo",
  duration: 750,
  autoplay: true // loop: true
...
imageAnimation.pause(); //\\//\\//\\//\\ END IMAGE ANIMATION //\\//\\//\\//\\
},{"animejs":"node_modules/animejs/lib/anime.es.js"}],"scoreAnimation.js":[function(require,module,exports) {
"use strict";
...
},{"animejs":"node_modules/animejs/lib/anime.es.js"}],"img/mapEng.jpg":[function(require,module,exports) {
module.exports = "/mapEng.2d8378f8.jpg";
},{}],"img/mappa.jpg":[function(require,module,exports) {
module.exports = "/mappa.c9d852d0.jpg";
...
},{"chart.js":"node_modules/chart.js/src/chart.js"}],"visualization.js":[function(require,module,exports) {
"use strict";
...
function _default(inputLabel) {
  //  // CHART AREA \\ \\
  // YEARS CHART
  var globalLabels = ["2008", "", " ", "", "2019"];
  var barOptions_stacked = {
    plugins: {
      datalabels: {
        ...
        formatter: function formatter(value, context) {
          return globalLabels[context.datasetIndex];
        }
      }
    },
    tooltips: {
    ...
    title: {
      display: true,
      text: inputLabel.years.title
    },
    animation: {
      animateScale: true,
      animateRotate: true
    },
    pointLabelFontFamily: "'Josefin Sans', sans-serif",
    scaleFontFamily: "'Josefin Sans', sans-serif"
  };
  var yearsCanvas = document.getElementById("years");
  var yearsChart = new _chart.default(yearsCanvas, {
    type: "horizontalBar",
    data: {
      labels: [""],
      datasets: [{
        label: inputLabel.years.dataset[0],
        data: [5],
        backgroundColor: "#D62835" // hoverBackgroundColor: "rgba(50,90,100,1)"

      }, {
        label: inputLabel.years.dataset[1],
        data: [0.5],
        backgroundColor: "#BA212D" // hoverBackgroundColor: "rgba(140,85,100,1)"

      }, {
        label: inputLabel.years.dataset[2],
        data: [2],
        backgroundColor: "#9E1A25" // hoverBackgroundColor: "rgba(46,185,235,1)"

      }, {
        label: inputLabel.years.dataset[3],
        data: [0.5],
        backgroundColor: "#84131E" // hoverBackgroundColor: "rgba(46,185,235,1)"

      }, {
        label: inputLabel.years.dataset[4],
        data: [2],
        backgroundColor: "#6A0D17" // hoverBackgroundColor: "rgba(46,185,235,1)"
  ...
  var cityCanvas = document.getElementById("city").getContext("2d");
  var configCity = {
    type: "doughnut",
    data: {
      datasets: [{
        data: [30, 1, 2, 2],
        backgroundColor: ["#D62835", "#BA212D", "#9E1A25", "#84131E"],
        label: "City"
      }],
      labels: inputLabel.city.dataset
    },
    options: {
      maintainAspectRatio: false,
      legend: {
  ...
  var cityChart = new Chart(cityCanvas, configCity); // TRAVEL CHART

  var travelCanvas = document.getElementById("travel");
  var configTravel = {
    type: "bar",
    data: {
      labels: ["2013", "2014", "2015", "2016", "2017", "2018", "2019"],
      datasets: [{
        label: inputLabel.travel.title,
        backgroundColor: "#D62835",
        data: [2, 10, 11, 14, 11, 10, 3]
      }]
    },
    options: {
      maintainAspectRatio: false,
  ...
  var travelChart = new Chart(travelCanvas, configTravel);
}
},{"chart.js":"node_modules/chart.js/src/chart.js","chartjs-plugin-datalabels":"node_modules/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.js"}],"chartLabelIta.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapIta = exports.labelEng = exports.labelIta = void 0;
var labelIta = {
  years: {
    title: "Timeline della nostra storia",
    dataset: ["amici", "conviventi nella nano house", "Fede va in Austria", "conviventi nella nano house", "insieme a Parigi "]
  },
  city: {
    title: "Città dove abbiamo vissuto",
    dataset: ["Milano", "Glasgow", "Linz", "Parigi"]
  },
  travel: {
    title: "Viaggi che abbiamo fatto (per anno)"
  }
};
exports.labelIta = labelIta;
var labelEng = {
  years: {
    title: "Timeline of our story",
    dataset: ["friend", "cohabitants in the nano house", "Fede goes to Austria", "cohabitants nano house", "toghether in Paris "]
  },
  city: {
    title: "Citys where we have lived",
    dataset: ["Milan", "Glasgow", "Linz", "Paris"]
  },
  travel: {
    title: "Travels that we have made( per year)"
  }
};
exports.labelEng = labelEng;
var mapIta = '';
exports.mapIta = mapIta;
},{}],"traduzione.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.mappaBig = void 0;

var _mapEng = _interopRequireDefault(require("./img/mapEng.jpg"));

var _mappa = _interopRequireDefault(require("./img/mappa.jpg"));

var _visualization = _interopRequireDefault(require("./visualization"));

var _chartLabelIta = require("./chartLabelIta");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mappaBig = _mappa.default;
exports.mappaBig = mappaBig;
...
exports.default = _default;
},{"./img/mapEng.jpg":"img/mapEng.jpg","./img/mappa.jpg":"img/mappa.jpg","./visualization":"visualization.js","./chartLabelIta":"chartLabelIta.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var _imageAnimation = require("./imageAnimation");

var _scoreAnimation = require("./scoreAnimation");

var _traduzione = _interopRequireWildcard(require("./traduzione"));
...
// SET THE TRANSLATION \\
window.addEventListener("load", (0, _traduzione.default)()); // anime({
//   targets: '.path',
//   strokeDashoffset: [anime.setDashoffset, 0],
//   stroke:['#00000000','#d62835'],
//   stroke:'#d62835',
//   fill: ['#00000000','#d62835'],
//   strokeWidth:[0, 1],
...
var mappaT = document.getElementById("mappa");
mappaT.addEventListener;

mappaT.onclick = function () {
  return window.open("".concat(_traduzione.mappaBig));
};
...
for (var i = 0; i < pathEls.length; i++) {
  ...
  var offset = _animejs.default.setDashoffset(pathEl);
...
// mappa.addEventListener
// mappa.onclick = () => window.open('/mappa.c9d852d0.jpg');
// /mappa.c9d852d0.jpg


var score = 0;
var risposte = ["prima risposta", "seconda risposta", "terza risposta", "quarta risposta"];
var nomeForm = ["primaDomanda", "secondaDomanda", "terzaDomanda", "quartaDomanda"];
var myFullpage = new _fullpage.default("#fullpage", {
  slideSelector: ".intro",
  anchors: ["facce_slide", "invitation_slide", "visualization_slide", "instruction_slide", "consigli_slide", "game_slide", "honey_moon", "conferma_slide"],
  menu: "#floatingMenu",
  ...
  afterLoad: function afterLoad(origin, destination, direction) {
    ...
    switch (destination.anchor) {
      case "facce_slide":
        _imageAnimation.imageAnimation.restart();

        break;

      case "invitation_slide":
        _textAnimation.textAnimation.restart();

        break;
    }
  },
  afterSlideLoad: function afterSlideLoad(section, origin, destination, direction) {
    var slidePosition = destination.index;

    if (slidePosition === 0) {
      score = 0;
      Array.from(document.querySelectorAll("input:checked"), function (input) {
    ...
    if (slidePosition === 4) {
      ...
      (0, _scoreAnimation.scoreAnimation)(score); // Reset the checkboxs

      Array.from(document.querySelectorAll("input:checked"), function (input) {
        return input.checked = false;
      });
    } // console.log("score after slide load:");
    // console.log(score);

  },
  onSlideLeave: function onSlideLeave(origin, destination, direction) {
    var slidePosition = destination.index;

    if (slidePosition < 4) {
      score += punteggio(choose(nomeForm[slidePosition]), risposte[slidePosition]);
    }
  }
});

var choose = function choose(formToPickUp) {
  // Pick up the form of the acutal slide
  var slideForm = document.getElementById(formToPickUp); // Create it as a form

  var data = new FormData(slideForm); // Transform it to array to check the length

  var dataToArray = Array.from(data); // console.log(dataToArray.length);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "35505" + '/');
...
},{}]},{},["../../../.nvm/versions/node/v10.11.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
