...
var labelEng = {
  years: {
    ...
    dataset: ["friends", "cohabitants in the nano-house", "Fede goes to Austria", "cohabitants in the nano-house", "toghether in Paris "]
  },
  city: {
    title: "Cities where we have lived in (in year)",
    dataset: ["Milan", "Glasgow", "Linz", "Paris"]
  },
  travel: {
    title: "Travels done togheter (per year)"
  }
};
...
var _default = function _default() {
  ...
  var textTravel = 'Support our desire to explore';
